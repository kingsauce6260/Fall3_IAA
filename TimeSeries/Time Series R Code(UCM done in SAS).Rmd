...
```{r}
ts_data<-read.csv("/Users/thomasgow/Downloads/TS_proj_agg.csv")
...
ARIMAX ADDED IN THE FOURIER TERMS

```{r}
df<-read.csv("/Users/thomasgow/Downloads/TS_proj_agg.csv")
...
THE PREDICTIONS FROM UCM GOTTEN IN SAS
